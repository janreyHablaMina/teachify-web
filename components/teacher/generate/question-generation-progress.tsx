...
const LOADING_MESSAGES = [
  "Teachify AI is writing your questions...",
  "Analyzing lesson content...",
  "Balancing question types...",
  "Adjusting difficulty level...",
  "Finalizing answer key...",
];

export function QuestionGenerationProgress({ onCancel }: QuestionGenerationProgressProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-[520px] py-4">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <div>
          <h3 className="m-0 text-[24px] font-black tracking-tight text-[#0f172a]">Generating your Questions</h3>
