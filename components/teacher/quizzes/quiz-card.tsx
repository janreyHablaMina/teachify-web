...
interface QuizCardProps {
  ...
  onAssignClick: (quiz: Quiz) => void;
  isDeleting?: boolean;
}

export function QuizCard({ quiz, onDeleteClick, onAssignClick, isDeleting }: QuizCardProps) {
  return (
          ...
          <div className="flex items-start justify-between gap-2">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="rounded-md border border-emerald-200 bg-emerald-50 px-2 py-1 text-[10px] font-black uppercase tracking-[0.06em] text-emerald-700 transition hover:border-emerald-300 hover:bg-emerald-100"
              >
                Assign
              </button>
              <button
